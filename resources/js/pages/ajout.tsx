        ...
        <div className={'container mx-auto flex min-h-screen items-center justify-center'}>
            ...
            <form onSubmit={handleSubmit} action="" method="post" className={'my-5 w-9/10 rounded border border-gray-300 p-5 md:w-auto'}>
                ...
                <textarea
                    name="description"
                    id="description"
                    className={"border border-gray-300 focus:outline-none resize-none w-full lg:min-w-100 h-100"}
                    value={data.description}
                    onChange={(e) => setData("description", e.target.value)}
                    required
                ></textarea><br/>
                <button onClick={() => {
                    if (confirm("Voulez-vous vraiment annuler l'envoi du formulaire ?")) {
